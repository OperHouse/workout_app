...
public class Selection_Ex_Preset_Fragment extends Fragment {
    ...
    private void showDeleteConfirmationDialog(ExerciseModel presetToDelete, int position, RecyclerView r) {
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                List<BaseExModel> p = new ArrayList<>(presetToDelete.getExercises());

                for (BaseExModel elm: p) {
    ...
    private void filterExerciseList(String text) {
        ...
        for (BaseExModel ex : ExDao.getAllExercises()) {
    ...
    private void filterPresetsList(String text) {
        List<ExerciseModel> filteredPresets = new ArrayList<>();
        for (ExerciseModel preset : PresetDao.getAllPresets()) {
            for (BaseExModel ex : preset.getExercises()) {
                if (ex.getExName().toLowerCase().contains(text.toLowerCase())) {
