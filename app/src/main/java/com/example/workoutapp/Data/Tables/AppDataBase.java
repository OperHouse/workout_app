...
public class AppDataBase extends SQLiteOpenHelper {
    ...
    public static final String WEIGHT_UID = "weight_Uid";
    ...
    public static final String DAILY_ACTIVITY_TRACKING_ACTIVITY_DISTANCE = "daily_activity_tracking_distance";
    ...
    // UID для тренировок и упражнений
    public static final String BASE_EXERCISE_UID = "base_exercise_uid";
    public static final String WORKOUT_PRESET_UID = "workout_preset_uid";
    public static final String WORKOUT_EXERCISE_UID = "workout_exercise_uid";
    public static final String SET_UID = "set_uid"; // Универсальный для силы и кардио

    // UID для питания
    public static final String BASE_FOOD_UID = "base_food_uid";
    public static final String PRESET_FOOD_UID = "preset_food_uid";
    public static final String MEAL_PRESET_UID = "meal_preset_uid";
    public static final String MEAL_NAME_UID = "meal_name_uid";
