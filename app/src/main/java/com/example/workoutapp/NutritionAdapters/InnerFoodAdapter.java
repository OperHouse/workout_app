...
public class InnerFoodAdapter  extends RecyclerView.Adapter<InnerFoodAdapter.InnerViewHolder>{
    ...
    private void updateMacrosUI(FoodModel food, TextView protein, TextView fat, TextView carb, TextView calories, com.example.workoutapp.NutritionCircleView circle) {
